...
if [ $CIRCLE_BRANCH = "ponzu-dev" ]; then
        ...
        cd /go/src/github.com/rpdict/ponzu
        git checkout ponzu-dev
        git pull origin ponzu-dev

        # create new project using the ponzu-dev branch
        ponzu new --dev github.com/rpdict/ci/test-project
else 
        ponzu new github.com/rpdict/ci/test-project
fi

cd /go/src/github.com/rpdict/ci/test-project
